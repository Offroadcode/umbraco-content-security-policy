...
namespace ContentSecurityPolicy.PackageActions
{
    /// <summary>
        ...
        public bool Execute(string packageName, XmlNode xmlData)
        {
            ...
            if (rootNode != null && name != null)
            {
                ...
                if (insertNode)
                {
                    ...
                    if (newRemoveNode.Attributes != null)
                    {
            ...
            if (modified)
            {
                ...
                catch (Exception e)
                {
                    ...
                    LogHelper.Error<AddHttpModule>(message, e);
                }
            }
            return result;
        }
        ...
        public bool Undo(string packageName, System.Xml.XmlNode xmlData)
        {
            ...
            if (rootNode != null && name != null)
            {
                ...
                if (rootNode.HasChildNodes)
                {
                    ...
                    var existingNodes = rootNode.SelectNodes(String.Format("remove[@name = '{0}']",
                        name));
                    ...
                    var xmlNodeList = rootNode.SelectNodes(String.Format("add[@name = '{0}']", name));
                    if (xmlNodeList != null)
                        foreach (XmlNode existingNode in xmlNodeList
                        )
                        {
            ...
            if (modified)
            {
                ...
                {
                    //Log error message
                    LogHelper.Error<AddHttpModule>("Error at undo AddHttpModule package action: " + e.Message, e);
                }
            }
            return result;
        }
        ...
        private bool GetAttribute(XmlNode xmlData, string attribute, out string value)
        {
            ...
            if (xmlData.Attributes != null)
            {
                ...
                else
                {
                    ...
                    LogHelper.Warn<AddHttpModule>(message);
                }
            }
            return result;
        }
